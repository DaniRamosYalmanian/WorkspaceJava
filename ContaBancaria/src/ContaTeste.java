...
public class ContaTeste {
	...
	public static void main(String[] args) {
		...
		if (controle == true) {
			System.out.println("Débito realizado: R$100,00" );
		} else {
			System.out.println("Débito não realizado. Saldo insuficiente");
		}
		controle = conta2.debitar(200);
		if (controle == true) {
			System.out.println("Débito realizado: R$200,00");
		} else {
			System.out.println("Débito não realizado. Saldo insuficiente");
		}		
		controle = conta3.debitar(3000);
		if (controle == true) {
			System.out.println("Débito realizado: R$3000,00");
		} else {
			System.out.println("Débito não realizado. Saldo insuficiente");
		}
